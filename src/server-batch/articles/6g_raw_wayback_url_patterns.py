...
def generate_starting_urls(json_dir):
    urls = set()
    # regex to match patterns like "iss01-07.html", "STS-98-19.html", or "STS-113-05.html"
    pattern = re.compile(r"((?:iss\d{2}|STS-\d{2,3}))-\d{2}(\.html)", re.IGNORECASE)
    ignore_urls = {
        ...
        "https://www.nasa.gov/centers/johnson/news/shuttle/sts-110/STS-110-01.html",
        "https://www.nasa.gov/centers/johnson/news/shuttle/sts-104/STS-104-01.html",
        "https://www.nasa.gov/centers/johnson/news/shuttle/sts-100/STS-100-01.html",
    }
